...
// const bonusQuestion = () => {
//   const confirmation = window.confirm("Are you sure you want to attempt Bonus Questions? This action is irreversible and you'll not be able to change solutions to these questions.");
...
// useEffect(() => {
  // if(bonus) {
  //   localStorage.setItem('allAttempted', true);
  // } 
// }, allAttempted)
