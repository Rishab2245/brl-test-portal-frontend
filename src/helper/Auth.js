export const signup = (user) => {
  return fetch(`https://reload24.mohitbharti.live/register`, {
    method: "POST",
    headers: {
...
export const signin = (user) => {
  ...
  return fetch(`https://reload24.mohitbharti.live/login`, {
    method: "POST",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
...
export const signout = (next) => {
  if (typeof window !== "undefined") {
    ...
    return fetch(`https://reload24.mohitbharti.live/logout`, {
      method: "GET",
    })
